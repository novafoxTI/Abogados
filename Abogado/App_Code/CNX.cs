    ...
    public  CNX() {
        ...
        public DataTable ObtenerDatoSicad(string comando)
        {
            try
            {
                ...
                using (SqlConnection cnSql = new SqlConnection("Data Source = BROWN; initial Catalog = ABOGADOS; integrated security=true; MultipleActiveResultSets = True; App = EntityFramework"))
