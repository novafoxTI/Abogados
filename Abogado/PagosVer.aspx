<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PagosVer.aspx.cs" Inherits="PagosVer" %>
...
<asp:Repeater runat="server" ID="DtgJuzgados">
            ...
            <table id="example1" class=" table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="width: 5%">Fecha Pago</th>
                        <th style="width: 5%">Pago</th>
                        <th style="width: 5%">Tipo Pago</th>
        ...
        <ItemTemplate>
            <tr data-id="<%# Eval("IDPago")%>">
                <td><%# Eval("fecha")%></td>
                <td><%# Eval("pago")%></td>
                <td><%# Eval("tipopago")%></td>
                <td><%# Eval("notas")%></td>
                 <td>
                <asp:LinkButton runat="server" ID="btnEditarJuzgado"  OnClick="btnEditarJuzgado_Click" CommandArgument='<%# Eval("IDPago") %>'>Editar</asp:LinkButton>
                </td>
                <td>
