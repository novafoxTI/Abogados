<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Juzgadosver.aspx.cs" Inherits="Juzgadosver" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Catálogo de Juzgados</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Menu</a></li>
              <li class="breadcrumb-item active">Catalogojuzgados</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
              ...
              <asp:Button runat="server" class="btn btn-block btn-success btn-lg" Text="Agregar Juzgados" ID="btnAgregarJuzgado" OnClick="btnAgregarJuzgado_Click" />

            <div class="card-header">
              <h3 class="card-title">Listado de Juzgados</h3>
