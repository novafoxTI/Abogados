      ...
      <div class="container-fluid">
       ...
       <form class="form-horizontal" runat="server" id="form1">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="TxtApellidoPaterno" placeholder="Ingresar apellido paterno">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="TxtApellidoMaterno" placeholder="Ingresar apellido materno">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="TxtCurp" placeholder="Ingresar CURP">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="TxtRfc" placeholder="Ingresar RFC">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" id="TxtFechaingreso" placeholder="Ingresar fecha ingreso">
            </div>
        </div>
